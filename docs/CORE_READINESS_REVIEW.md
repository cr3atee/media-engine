...
- live unattended polling verification;
...
- Live unattended polling verification is not complete.
...
1. Live polling monitoring.
   Use the runtime monitoring foundation to add guarded operational checks
   around live marketplace integration execution before relying on unattended
   scheduled ingestion.
