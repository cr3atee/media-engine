...
async def main() -> None:
    """Run repository-backed marketplace offers through the comparator flow."""
    ...
    async with HttpClient() as http_client:
        marketplace_pipeline = MarketplacePipeline(
    ...
    print(f"  Canonical Products: {len(canonical_products)}")
    print()
    ...
    for result in comparison_results:
        if result.canonical_product is None:
            ...
            print(f"Canonical Product: {result.canonical_product.name}")
